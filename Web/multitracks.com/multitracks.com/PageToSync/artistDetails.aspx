							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									<div class="discovery--section--header">
										<h2>Top Songs</h2>
										<asp:LinkButton class="discovery--section--header--view-all" runat="server" ID="songViewAll" OnClick="SongViewAll_Click">View All</asp:LinkButton>
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										<div class="discovery--section--header">
											<h2>Albums</h2>
											<asp:LinkButton class="discovery--section--header--view-all" runat="server" ID="albumViewAll" OnClick="AlbumViewAll_Click">View All</asp:LinkButton>
										</div><!-- /.discovery-select -->
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<asp:Label runat="server" ID="biography" />
									</div>
